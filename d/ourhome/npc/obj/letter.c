...
// 解决找人帮忙送信，或者送别人的信的bug
        ...
        {
                tell_object(me,ob->name()+"拆开信看了看，生气地瞪了你一眼。\n");
...
*/
                ...
                CHANNEL_D->do_channel(this_object(),"sys",NOR+me->name()+"将信送给"+ob->name()+"获得"HIR+daoxing(i)+NOR"的道行，"HIY+chinese_number(qn)+NOR"点潜能\n");
