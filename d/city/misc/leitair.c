...
//    string *banned_cast=({"escape","yueying","chuqiao","qiankun","jieti","tudun","shuidun","yinshen"});
...
void fullup(object obj) {
  ...
  if (!obj) return;
  obj->set("kee",(int)obj->query_temp("leitai1/kee"));
  obj->set("eff_kee",(int)obj->query_temp("leitai1/eff_kee"));
  obj->set("sen",(int)obj->query_temp("leitai1/sen"));
  obj->set("eff_sen",(int)obj->query_temp("leitai1/eff_sen"));
  obj->set("force", (int)obj->query_temp("leitai1/force"));
  obj->set("mana",(int)obj->query_temp("leitai1/mana"));

  obj->clear_condition();
  if (conditions=obj->query_temp("leitai1/conditions")) {
    condition_values=obj->query_temp("leitai1/condition_values");
...
void pre_status(object obj) {
  ...
  if (!obj) return;
  obj->set_temp("leitai1/kee",(int)obj->query("kee"));
  obj->set_temp("leitai1/eff_kee",(int)obj->query("eff_kee"));
  obj->set_temp("leitai1/sen",(int)obj->query("sen"));
  obj->set_temp("leitai1/eff_sen",(int)obj->query("eff_sen"));
  obj->set_temp("leitai1/force", (int)obj->query("force"));
  obj->set_temp("leitai1/mana",(int)obj->query("mana"));
  ...
  if (con=obj->query_condition()) {
    ...
    obj->set_temp("leitai1/conditions",conditions);
    obj->set_temp("leitai1/condition_values",condition_values);
  }
  obj->clear_condition();
}       
...
void broadcast(string msg) {
  object room=load_object(__DIR__"kantai1");
