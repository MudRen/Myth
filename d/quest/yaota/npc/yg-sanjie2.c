...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("huxiaoquan", level*20);
        set_skill("zhaoyangbu", level*20);
        set_skill("blade", level*20);
        set_skill("zileidao", level*20);
        set_skill("huntianforce", level*20);
        set_skill("literate", 180);
        set_skill("tianmogong", level*20);
        map_skill("spells", "tianmogong");
        map_skill("force", "huntianforce");
        map_skill("unarmed", "huxiaoquan");
        map_skill("parry", "zileidao");
        map_skill("sword", "zileidao");
