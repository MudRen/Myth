...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("jinghun-zhang", level*20);
        set_skill("ghost-steps", level*20);
        set_skill("sword", level*20);
        set_skill("whip", level*20);
        set_skill("stick", level*20);
        set_skill("kusang-bang", level*20);
        set_skill("zhuihun-sword", level*20);
        set_skill("hellfire-whip", level*20);
        set_skill("tonsillit", level*20);
        set_skill("literate", 180);
        set_skill("gouhunshu", level*20);
