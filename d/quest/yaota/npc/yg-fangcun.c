...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("liangyi-sword", level*20);
        set_skill("dao", level*20);
        set_skill("puti-zhi", level*20);
        set_skill("wuxiangforce", level*20);
        set_skill("qianjun-bang", level*20);
        set_skill("jindouyun", level*20);
