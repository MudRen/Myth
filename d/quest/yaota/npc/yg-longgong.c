...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("fork", level*20);
        set_skill("dragonfight", level*20);
        set_skill("dragonforce", level*20);
        set_skill("seashentong", level*20);
        set_skill("dragonstep", level*20);
        set_skill("fengbo-cha", level*20);
        map_skill("spells", "senshentong");
