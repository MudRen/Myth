...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("yinsuo-jinling", level*20);
        set_skill("sword",level*20);
        set_skill("chixin-jian",level*20);
        set_skill("yueying-wubu", level*20);
        set_skill("pansi-dafa", level*20);
        set_skill("lanhua-shou", level*20);
        set_skill("jiuyin-xinjing", level*20);
