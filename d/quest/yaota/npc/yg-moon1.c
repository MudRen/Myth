...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("baihua-zhang", level*20);
        set_skill("moondance", level*20);
        set_skill("whip", level*20);
        set_skill("jueqingbian", level*20);
        set_skill("moonshentong", level*20);
        set_skill("moonforce", level*20);
