...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("jienan-zhi", level*20);
        set_skill("lotusmove", level*20);
        set_skill("staff", level*20);
        set_skill("lunhui-zhang", level*20);
        set_skill("lotusforce", level*20);
        set_skill("literate", 180);
        set_skill("buddhism", level*20);
