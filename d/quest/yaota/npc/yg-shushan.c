...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("shushan-jianfa", level*20);
        set_skill("yujianshu", level*20);
        set_skill("mindsword", level*20);
        set_skill("canxin-jian", level*20);
        set_skill("taoism", level*20);
        set_skill("hunyuan-zhang", level*20);
        set_skill("zixia-shengong", level*20);
        set_skill("sevensteps", level*20);
