...
//        if(level==0) level=random(40)+10; 
        ...
        set_skill("cuixin-zhang", level*20);
        set_skill("bingpo-blade", level*20);
        set_skill("blade", level*20);
        set_skill("sword", level*20);
        set_skill("xiaoyaoyou", level*20);
        set_skill("ningxie-force", level*20);
        set_skill("literate", 180);
        set_skill("dengxian-dafa", level*20);
