...
int give_mark()
{
          object who, tianjuepai, jueqingpai,yihuapai,qingfengpai,chixinpai,wuyoupai,tianyapai,wangyoupai,saiyaqi,jieyipai,bihaigepai,datangpai,happypai;
        string club;
        who=this_player();
        club=who->query("club");
        ...
        tianyapai=new("/d/obj/club/tianya_mark");
          happypai=new("/d/obj/club/happy_mark");
        if ( club == 0 )
        {
                command("hehe");
        ...
        switch ( club )
        {
                ...
                break;
                 ...
                 case "欢乐城":
                 command("nod "+who->query("id"));
                 happypai->set("obj_owner",who->query("id"));
                 happypai->move(who);
                 break;
                default:
                command("hoho");
