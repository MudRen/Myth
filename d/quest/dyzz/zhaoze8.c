...
LONG
        ...
        set("exits", ([ 
                ...
                "north" : __DIR__"zhaoze4",
                "south" : __DIR__"zhaoze7",
                "east"  : __DIR__"zhaoze6",
                "down"  : __DIR__"quickmud8",
        ]));
        set("objects", ([   
...
int do_pull ( string arg)
{
        ...
        room = load_object(__DIR__"quickmud8");
