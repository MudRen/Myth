...
LONG
        ...
        set("exits", ([ 
                ...
                "south" : __DIR__"zhaoze6",
                "east"  : __DIR__"zhaoze0",
                "down"  : __DIR__"quickmud3",
        ]));
        set("objects", ([   
...
int do_pull ( string arg)
{
        ...
        room = load_object(__DIR__"quickmud3");
