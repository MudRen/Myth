...
LONG
        ...
        num = random(3)+2;
        set("exits", ([ 
                "west" : __DIR__"zhaoze8",
                "north" : __DIR__"zhaoze3",
                "south" : __DIR__"zhaoze5",
                "east"  : __DIR__"zhaoze2",
                "down"  : __DIR__"quickmud6",
        ]));
        set("objects", ([   
                __DIR__"obj/wetmud" : 1,
                __DIR__"obj/jadesword" : 1,
                __DIR__"obj/skeleton" : 1,
                __DIR__"npc/yg-level10" : 2,
        ]) );
...
int do_pull ( string arg)
{
        ...
        room = load_object(__DIR__"quickmud6");
