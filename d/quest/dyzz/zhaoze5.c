...
LONG
        ...
        num = random(3)+2;
        set("exits", ([ 
                "west" : __DIR__"zhaoze7",
                "north" : __DIR__"zhaoze6",
                "south" : __DIR__"zhaoze3",
                "east"  : __DIR__"zhaoze1",
                "down"  : __DIR__"quickmud5",
        ]));
        set("objects", ([   
                __DIR__"obj/wetmud" : 1,
                __DIR__"npc/yg-level5" : 1,
                __DIR__"npc/yg-level10" : 1,
        ...
        wetmud= present("wetmud", this_object());
        ske->move(wetmud);
}
...
int do_pull ( string arg)
{
        ...
        room = load_object(__DIR__"quickmud5");
