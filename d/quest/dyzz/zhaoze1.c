...
LONG
        ...
        num = random(3)+3;
        set("exits", ([ 
                "west" : __DIR__"zhaoze5",
                "north" : __DIR__"zhaoze2",
                "south" : __DIR__"zhaoze0",
                "east"  : __DIR__"zhaoze7",
                "down"  : __DIR__"quickmud1",
        ]));
        set("objects", ([   
                __DIR__"obj/wetmud" : 1,
                "/obj/money/gold": 1,
                "/obj/money/silver": 1,
                __DIR__"npc/yg-level0" : 1,
...
int do_pull ( string arg)
{
        ...
        room = load_object(__DIR__"quickmud1");
