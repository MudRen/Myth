...
int do_zhu(string arg)
{
        ...
        while(i--)
                if( id[i]<'a' || id[i]>'z' )
                        return notify_fail("对不起，锤的英文代号只能用英文字母。\n");
        ...
        message_vision(me->name()+"沉吟了一会，对侍锤巧声说了几句话。侍锤点了点头。说：好吧！\n",me );
        ...
        club=new("/d/quest/m_weapon/weapon/m_hammer",1);    //生成新锤
        club->move(this_player());
        message_vision("侍锤摸起地上，带着斑斑血迹还有些烫手的巨锤，说：\n锤。。已。。成。。，侍锤的任务。。。也就完成了。。。。\n",me );
