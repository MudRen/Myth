...
int do_yelian()
{
        ...
        switch(random(4) ) {
                case 0:
                        new_ob=new("/d/quest/m_weapon/tan/item/jinmu",1);
                        new_ob->move(me);                       
                        message_vision(HIY "补天石渐渐变形，终于成了一块紫色的金属！！\n" NOR, me );
                        me->set_temp("get_orc",1);
                        destruct(stone);
                        break;
                case 1:
                        new_ob=new("/d/quest/m_weapon/tan/item/shenmu",1);
                        new_ob->move(me);                       
                        ...
                        break;
                case 2:
                        new_ob=new("/d/quest/m_weapon/tan/item/hanzhu",1);
                        new_ob->move(me);                       
