...
{ 
 ...
 //   i=(random(sizeof(names4)/2))*2; 
     ...
     set("b_lvl",i+1); 
        i=i+1; 
        switch(i){ 
                case 1:   name="红";         ids="hong";        break; 
                case 2:   name="蓝";         ids="blue";        break; 
                case 3:   name="绿";         ids="green";       break; 
                case 4:   name="青";         ids="qing";        break; 
                case 5:   name="黄";         ids="huang";       break; 
                case 6:   name="紫";         ids="zi";          break; 
                case 7:   name="橙";         ids="cheng";       break; 
                case 8:   name="玛瑙";       ids="manao";       break; 
                case 9:   name="翡翠";       ids="feicui";      break; 
                case 10:   name="沉玉";      ids="chengyu";     break; 
                case 11:   name="水晶";      ids="shuijing";    break; 
                case 12:   name="金沙";      ids="jinsha";      break; 
                case 13:   name="猫眼";      ids="maoyan";      break; 
                case 14:   name="钻石";      ids="zuanshi";     break; 
                case 15:   name="神之玛瑙";  ids="god manao";    break; 
                case 16:   name="神之翡翠";  ids="god feicui";   break; 
                case 17:   name="神之沉玉"; ids="god chengyu";  break; 
                case 18:   name="神之水晶"; ids="god shuijing"; break; 
                case 19:   name="神之金沙"; ids="god jinsha";   break; 
                case 20:   name="神之猫眼"; ids="god maoyan";   break; 
                case 21:   name="神之钻石"; ids="god zuanshi";  break; 
                case 22:   name="旭日";    ids="sun";         break; 
                case 23:   name="天空";    ids="sky";         break; 
                case 24:   name="森林";    ids="forest";      break; 
                case 25:   name="海洋";    ids="sea";         break; 
                case 26:   name="火焰";    ids="fire";        break; 
                case 27:   name="晚霞";    ids="sunshine";    break; 
                case 28:   name="沙漠";    ids="sand";        break; 
...
//      return notify_fail("这件装备不能镶嵌宝石。\n"); 
  ...
  { 
       ...
       tell_room(environment(me),HIB"只见"+ob->name()+HIB"化做一道奇怪的光,钻入了"+in_obj->query("name")+HIB"里面,不见了! \n"NOR); 
 //判断同类宝石 
      if(j==1){ 
...
//武器 
       message_vision(CYN"$N把$n"+CYN"镶嵌到"+in_obj->query("name")+CYN"上 \n"NOR,me,ob); 
       tell_room(environment(me),HIB"只见"+ob->name()+HIB"化做一道奇光,钻入了"+in_obj->query("name")+HIB"里面,不见了! \n"NOR); 
