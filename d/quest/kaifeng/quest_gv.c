...
mapping quests_give = ([
      ...
      40 : ({ "give", "游客",         "youke",       "",                     "1" }),
      45 : ({ "give", "路人",         "luren",       "",                     "1" }),
      50 : ({ "give", "江湖艺人",     "yi ren",      "白银(silver)",         "1" }),
      55 : ({ "give", "浣衣女",       "girl",        "白银(silver)",         "1" }),
      60 : ({ "give", "阿七婆",       "aqi po",      "",                     "1" }),
      65 : ({ "give", "农夫",         "farmer",      "",                     "1" }),
      70 : ({ "give", "樵夫",         "qiao fu",     "",                     "1" }),
     100 : ({ "give", "庙祝",         "miao zhu",    "黄金(gold)",           "1" }),
     ...
     130 : ({ "give", "轿夫",         "jiaofu",      "白银(silver)",         "1" }),
     135 : ({ "give", "轿夫头",       "jiaofu tou",  "白银(silver)",         "1" }),
     140 : ({ "give", "唢呐手",       "suona shou",  "白银(silver)",         "1" }),

    1000 : ({ "give", "学童",         "xue tong",    "〖三字经〗(book)",     "1" }),
    2000 : ({ "give", "小童",         "kid",         "〖三字经〗(book)",     "1" }),
    3000 : ({ "give", "吃客",         "chi ke",      "炸鸡腿(jitui)",        "1" }),
    4000 : ({ "give", "农家女",       "nongjia nu",  "白银(silver)",         "1" }),
    5000 : ({ "give", "书呆子",       "shudai zi",   "〖三字经〗(book)",     "1" }),

    6000 : ({ "give", "少妇",         "woman",       "白银(silver)",         "1" }),
    7000 : ({ "give", "中年妇女",     "woman",       "白银(silver)",         "1" }),
    8000 : ({ "give", "老妇人",       "old woman",   "白银(silver)",         "1" }),
    9000 : ({ "give", "老妇",         "lao fu",      "白银(silver)",         "1" }),

   10000 : ({ "give", "渔夫",         "yu fu",       "钢叉(gang cha)",       "1" }),
   11000 : ({ "give", "樵夫",         "qiao fu",     "大板斧(bigaxe)",       "1" }),
   12000 : ({ "give", "妇女",         "fu nu",       "粉红绸衫(pink cloth)", "1" }),
   13000 : ({ "give", "街头小商人",   "shang ren",   "黄金(gold)",           "1" }),
   14000 : ({ "give", "乞丐",         "qi gai",      "白银(silver)",         "1" }),
   15000 : ({ "give", "艺人",         "yi ren",      "白银(silver)",         "1" }),
   16000 : ({ "give", "车夫",         "che fu",      "白银(silver)",         "1" }),
   17000 : ({ "give", "路人",         "luren",       "白银(silver)",         "1" }),
   18000 : ({ "give", "老婆婆",       "old woman",   "白银(silver)",         "1" }),

   21000 : ({ "give", "摇铃水客",     "yaoling shuike", "白银(silver)",         "1" }),
   ...
   26000 : ({ "give", "女佣",         "nu yong",     "白银(silver)",         "1" }),
   27000 : ({ "give", "女仆",         "nu pu",       "白银(silver)",         "1" }),
   28000 : ({ "give", "男仆",         "nan pu",      "白银(silver)",         "1" }),
   29000 : ({ "give", "饥民",         "ji min",      "白银(silver)",         "1" }),

   31000 : ({ "give", "瘦子",         "shou zi",     "白银(silver)",         "1" }),
   32000 : ({ "give", "断肠妇人",     "duanchang furen", "白银(silver)",         "1" }),

   41000 : ({ "give", "穷和尚",       "he shang",    "白银(silver)",         "1" }),
   42000 : ({ "give", "瘦和尚",       "he shang",    "白银(silver)",         "1" }),
   43000 : ({ "give", "小和尚",       "heshang",     "白银(silver)",         "1" }),
   44000 : ({ "give", "老和尚",       "heshang",     "白银(silver)",         "1" }),
   45000 : ({ "give", "守寺僧",       "shousi seng", "短弯刀(duan wan dao))","1" }),
   46000 : ({ "give", "书生",         "shu sheng",   "白银(silver)",         "1" }),

   52000 : ({ "give", "挑灯夫",       "tiaodeng fu", "白银(silver)",         "1" }),
   ...
   75000 : ({ "give", "居民",         "ju min",      "白银(silver)",         "1" }),
   76000 : ({ "give", "市民",         "shi min",     "白银(silver)",         "1" }),
  ...
  100020 : ({ "give", "珠怜",         "ban niang",   "玉佩(yu pei)",     "1" }),

  110000 : ({ "give", "蒲牢",         "pu lao",      "水晶腰牌(yao pai)",    "1" }),
  120000 : ({ "give", "狴犴",         "bi an",       "水晶腰牌(yao pai)",    "1" }),
  130000 : ({ "give", "睚眦",         "ya zi",       "水晶腰牌(yao pai)",    "1" }),
  140000 : ({ "give", "霸下",         "ba xia",      "水晶腰牌(yao pai)",    "1" }),
  150000 : ({ "give", "螭吻",         "chi wen",     "水晶腰牌(yao pai)",    "1" }),
  160000 : ({ "give", "饕餮",         "tao tie",     "水晶腰牌(yao pai)",    "1" }),
  170000 : ({ "give", "蚣蝮",         "gong fu",     "水晶腰牌(yao pai)",    "1" }),
  180000 : ({ "give", "金猊",         "jin ni",      "水晶腰牌(yao pai)",    "1" }),
  190000 : ({ "give", "椒图",         "shu tu",      "水晶腰牌(yao pai)",    "1" }),
/*
  200000 : ({ "give", "曹国舅","cao guojiu",  "【太乙真经】(taiyi zhenjing)","1" }),
  210000 : ({ "give", "韩湘子","han xiangzi", "【太乙真经】(taiyi zhenjing)","1" }),
  220000 : ({ "give", "汉钟离","han zhongli", "【太乙真经】(taiyi zhenjing)","1" }),
  230000 : ({ "give", "何仙姑","he xiangu",   "【太乙真经】(taiyi zhenjing)","1" }),
  240000 : ({ "give", "蓝采和","lan caihe",   "【太乙真经】(taiyi zhenjing)","1" }),
  250000 : ({ "give", "铁拐李","tieguai li",  "【太乙真经】(taiyi zhenjing)","1" }),
  260000 : ({ "give", "张果老","zhang guolao","【太乙真经】(taiyi zhenjing)","1" }),
