...
//  860000 : ({ "ask", "如来佛",       "rulai fo",           "取经",               "1" }),
 ...
 2000000 : ({ "ask", HIW "格西"NOR,     "ge xi",              "参加水陆大会", "1" }), 
 2000010 : ({ "ask", HIG "长眉"NOR,     "chang mei",          "参加水陆大会", "1" }),
 2000020 : ({ "ask", YEL "木惠"NOR,     "mu hui",             "参加水陆大会", "1" }),
 2000030 : ({ "ask", CYN "木提子"NOR,   "mu tizi",            "参加水陆大会", "1" }),
 2000040 : ({ "ask", MAG "乌亚子"NOR,   "wu yazi",            "参加水陆大会", "1" }),
 2000050 : ({ "ask", HIR "红霞"NOR,     "hong xia",           "参加水陆大会", "1" }),
 2000060 : ({ "ask", HIC "龙飞"NOR,     "long fei",           "参加水陆大会", "1" }),
 2000070 : ({ "ask", HIM "阿布及"NOR,   "a buji",             "参加水陆大会", "1" }),
 2000080 : ({ "ask", HIY "启心祖师"NOR, "master qixin",       "参加水陆大会", "1" }),
 2000090 : ({ "ask", HIB "乙穆"NOR,     "yi mu",              "参加水陆大会", "1" }),
 2000110 : ({ "ask", WHT "缥缈"NOR,     "piao miao",          "参加水陆大会", "1" }),
 2000120 : ({ "ask", HIW "天极"NOR,     "tian ji",           "参加水陆大会", "1" }),
 2000130 : ({ "ask", HIR "摩柯切叶"NOR, "moke qieye",         "参加水陆大会", "1" }),
 2000140 : ({ "ask", HIY "阿若陀"NOR,   "a ruotuo",           "参加水陆大会", "1" }),
