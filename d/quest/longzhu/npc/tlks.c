...
//        set("rank_info/respect", "宝宝");
        ...
        set("chat_msg_combat", ({
           ...
           if (clonep()) 
           {
           object ob = unew("/d/quest/longzhu/armor/muji.c"); 
           object ob1 = unew("/d/quest/longzhu/weapon/duanjian.c"); 
           if (!ob) ob = new("/d/quest/longzhu/armor/mujifake.c");  
           ob->move(this_object()); 
           ob->wear(); 
           if (!ob1) ob1 = new("/d/quest/longzhu/weapon/duanjianfake.c");  
