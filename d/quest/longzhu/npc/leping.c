...
void create()
{
        ...
        setup();
// 33          carry_object("/d/quest/longzhu/armor/xingtian")->wear();
    if (clonep())
    {
        object ob = unew("/d/quest/longzhu/armor/xingtian.c");
        if (!ob) ob = unew("/d/quest/longzhu/armor/xingtianfake.c"); 
        ob->move(this_object());
        ob->wear();
