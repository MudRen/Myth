...
{ 
        ...
        if (level==1) guai_value = max_value+max_value/8; 
                ...
                set_skill("jinghun-zhang", guai_value+20+random(16)); 
                set_skill("tonsillit", guai_value+20+random(16)); 
                set_skill("hellfire-whip", guai_value+20+random(16)); 
                set_skill("ghost-steps", guai_value+20+random(16)); 
