...
void create (int level,int num)
{
  ...
  set ("long", @LONG
阴森恐怖的毒蛇洞终于走到了尽头，等待你的不是喜悦，而是更加惊险
的探险道路，你可以坐下来休息一下了。
LONG);
     level=10; num=random(2)+1;
    set("exits", ([ 
             "west" : __DIR__"dushedong14",
//             "east" : __DIR__"dushedong15",
//                "northwest" : __DIR__"dushedong5",
//                 "southwest" : __DIR__"dushedong4",
                                 ]));
