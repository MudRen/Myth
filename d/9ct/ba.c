...
string *banned_action=({
  "practice","exercise","meditate","xiudao","learn","study",
  "read","bian","quit","accept","fly","surrender","move","recall"
});
string *list=({
        "9ctguai1","9ctguai2",
});
...
LONG);
  ...
  set("exits", ([
           "up" : __DIR__"tree8",
        "east" : __DIR__"baoku15",
        "enter" : __DIR__"baoku16",
      ]));
  set("objects", ([
