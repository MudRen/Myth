...
void create ()
{
  set ("short",HIW"精华台"NOR);
        set ("long", @LONG

相传该仙台是盘古开天辟地之后所设,这里是造就天地精华,炼就法宝
的地方,旁边的一块碑文上镌刻有"天极"两个大字。 底下还密密麻麻
地刻了一篇小字(words)，隔远了也看不清说的是什么。
...
LONG);
  ...
  set("objects", ([
                "/d/9ct/npc/gueiwei.c" : 1,
             "/d/9ct/npc/shouhu.c" : 1,
      ]));
