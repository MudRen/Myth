...
// 防止数据越来越大,数据溢出
        ...
        case 0:
                ...
                //str +=combat_exp_bonus+"武学经验，";
                str += COMBAT_D->chinese_daoxing(daoxing_bonus)+"道行。";
                tell_object(me,"你得到了"+potential_bonus+"点潜能，"+COMBAT_D->chinese_daoxing(daoxing_bonus)+"道行。\n");
                break;
        case 1:
                daoxing_bonus = 0;
                me->add("potential", potential_bonus);
                ...
                str +=combat_exp_bonus+"武学经验，";
                //str += COMBAT_D->chinese_daoxing(daoxing_bonus)+"道行。";
                tell_object(me,"你得到了"+potential_bonus+"点潜能，"+combat_exp_bonus+"武学经验。\n");         
                break;
        case 2:
        ...
        case 4:
                ...
                str =combat_exp_bonus+"武学经验，";
                str += COMBAT_D->chinese_daoxing(daoxing_bonus)+"道行。";
                tell_object(me,"你得到了"+combat_exp_bonus+"武学经验，"+COMBAT_D->chinese_daoxing(daoxing_bonus)+"道行。\n");
                break;        
        }
        me->add("weiwang",3+random(3));
              
        str = "完成了一个难度"+chinese_number(level)+"的"+kind+"妖任务，" + str;
