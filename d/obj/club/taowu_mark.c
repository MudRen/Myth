...
#include <ansi.h>
#include <weapon.h>
#define CLUB_NAME "心仪桃巫宫"
#define CLUB_ID "taowu"
#define CLUB_CHANNEL "taowu"
#define CLUB_MARK "taowu necklace"
inherit SWORD;
...
void create()
{
set_name(HIM"桃巫令"NOR,({"taowu necklace","necklace","club_mark","sword","jian"}));
	set_weight(0);
...
string show_level(object user)
{
 ...
 mapping info;
 string str;
  if(wizardp(user)) return "【荣誉会员】心仪桃巫宫荣誉帮众  ";
