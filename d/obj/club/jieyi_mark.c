...
#include <ansi.h>
#include <weapon.h>
#define CLUB_NAME "神州结义帮"
#define CLUB_ID "jieyi"
#define CLUB_CHANNEL "jieyi"
#define CLUB_MARK "jieyi necklace"
inherit SWORD;
...
void create()
{
         set_name(HIM"神州结义帮的信物"NOR,({"jieyi necklace","necklace","club_mark","sword","jian"}));
        set_weight(0);
...
这是一个五彩玉佩令牌，隐隐幻出字型，此乃神州结义帮之信物。
你可以用(help jieyi)来查看神州结义帮指令。若想了解神州结
义帮的历史可以用(about jieyi)来取得进一步的资料。
...
string show_level(object user)
{
 ...
 mapping info;
 string str;
 if(wizardp(user)) return "【荣誉会员】神州结义帮荣誉帮众  ";
 ...
 switch(rank)
 {
        case 10: str+="神州结义帮帮主      "; break;
        case 9: str+="神州结义帮帮主相公  "; break;
        case 8: str+="神州结义帮门主    "; break;
        case 7: str+="神州结义帮帮主护卫  "; break;
        case 6: str+="神州结义帮资深长老  "; break;
        case 5: str+=info["info1"]+"分堂主    "; break;
        case 4: str+=info["info1"]+"副堂主    "; break;
        case 3: str+="神州结义帮护法      "; break;
        case 2: str+="神州结义帮侍女      "; break;
...
int do_handover(string arg)
{
        ...
        else
        {
                ...
                if(sizeof(ob_info))
                {
                        ...
                        message_vision("$N将"+CLUB_NAME+"的帮主之位移交给$n。\n",me,ob);
                        message( "channel:chixin",CYN"【"+CLUB_NAME+"】"+me->name(1)+"("+capitalize(me->query("id"))+")将"+CLUB_NAME+"帮主之位移交给"+ob->name(1)+"("+capitalize(ob->query("id"))+")。\n"NOR, users() );
                        ob->save();
                        me->save();
                        return 1;
                }
...
int do_help(string arg)
{
 if(arg=="jieyi")
 {
  write(@HELP
       ...
       │  dismiss <人名>              │取消某人分堂职务  │护卫专用    │
       │  accept <人名>               │让某人加入帮会    │楼主相公专用│
       │  kickout <人名>              │将某人逐出帮会    │楼主相公以上│
       │  subleader <人名> to <分堂名>│升级某人为分堂主  │少门主以上  │
       │  retire <人名>               │撤除某人分堂主职位│长老以上    │
       │  givepower <人名> to <等级>  │改变某人的职位    │楼主相公以上│
