...
#include <ansi.h>
#include <weapon.h>
#define CLUB_NAME "天涯海阁"
#define CLUB_ID "tianya"
#define CLUB_CHANNEL "tianya"
#define CLUB_MARK "tianya necklace"
inherit SWORD;
...
void create()
{
         set_name(HIG"天涯海阁的信物"NOR,({"tianya necklace","necklace","club_mark","sword","jian"}));
        set_weight(0);
...
这是一个七彩令牌，隐隐幻出淡淡光线，此乃天涯海阁之信物。
你可以用(help tianya)来查看有什么青风细雨楼指令。若想了解天涯海阁
的历史可以用(about tianya)来取得进一步的资料。
...
string show_level(object user)
{
 ...
 mapping info;
 string str;
 if(wizardp(user)) return "【荣誉会员】天涯海阁荣誉帮众  ";
 ...
 switch(rank)
 {
        case 10: str+="天涯海阁阁主      "; break;
        case 9: str+="天涯海阁阁主相公  "; break;
        case 8: str+="天涯海阁门主    "; break;
        case 7: str+="天涯海阁阁主护卫  "; break;
        case 6: str+="天涯海阁资深长老  "; break;
        case 5: str+=info["info1"]+"分堂主    "; break;
        case 4: str+=info["info1"]+"副堂主    "; break;
        case 3: str+="天涯海阁护法      "; break;
        case 2: str+="天涯海阁宫女      "; break;
...
*/
                 ...
                 else
                {
                 ...
                 mark->move(ob);
                 ob->add("channels", ({"tianya"}));
                 ob->add("club", "天涯海阁");
                 ob->add("title", HIG"天涯海阁" NOR);
                 ob->save();
                }
        return 1;
}
...
int do_help(string arg)
{
 if(arg=="tianya")
 {
  write(@HELP
       ...
       │  accept <人名>               │让某人加入帮会    │阁主相公专用│
       │  kickout <人名>              │将某人逐出帮会    │阁主相公以上│
       │  subleader <人名> to <分堂名>│升级某人为分堂主  │少门主以上  │
       │  retire <人名>               │撤除某人分堂主职位│长老以上    │
       │  givepower <人名> to <等级>  │改变某人的职位    │阁主相公以上│
