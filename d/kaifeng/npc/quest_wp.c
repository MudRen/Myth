...
mapping quests_weapon = ([
     ...
     100 : ({ "find", "Ìú´¸",         "hammer",             "", "1" }),
     150 : ({ "find", "¹ðÊ÷Ö¦",       "guishuzhi",          "", "1" }),
     200 : ({ "find", "ïÙÌú¹÷",       "bintiegun",          "", "1" }),
     220 : ({ "find", "ÆëÃ¼¹÷",       "qimeigun",           "", "1" }),
     240 : ({ "find", "ÖñÉ¨Öã",       "broom",              "", "1" }),
     260 : ({ "find", "Ä¾°ô",         "mu bang",            "", "1" }),
     280 : ({ "find", "Ä¾²æ",         "fork",               "", "1" }),
     300 : ({ "find", "·ç»ØÑ©Îè½£",   "snowsword",          "", "1" }),

     400 : ({ "find", "¾Å¹ÉÍÐÌì²æ",   "tuotian fork",       "", "1" }),
     500 : ({ "find", "°Ë°êÃ·»¨´¸",   "meihua hammer",      "", "1" }),
     600 : ({ "find", "Ìú¸«",         "lumber axe",         "", "1" }),
  ...
  320000 : ({ "find", HIC "µã¸ÖÇ¹" NOR, "steel spear",     "", "1" }),

  400000 : ({ "find", "Ðå»¨Õë",       "xiuhua zhen",        "", "1" }),
  420000 : ({ "find", "±ÌÓñË«Ç¹",     "jade spear",         "", "1" }),
  440000 : ({ "find", "Çà·æ½£",       "qingfeng sword",     "", "1" }),
  460000 : ({ "find", "ÎÞ³£°ô",       "wuchang bang",       "", "1" }),
 ...
 1500000 : ({ "find", "×Ï½ðºìºùÂ«",   "hu lu",              "", "1" }),
 1600000 : ({ "find", "ÑòÖ¬Óñ¾»Æ¿",   "jing ping",          "", "1" }),
 1700000 : ({ "find", "ÆÐÌáÕÈ",       "puti zhang",         "", "1" }),
 1800000 : ({ "find", HIY"¾Å»·ÎýÕÈ"NOR, "nine-ring staff",  "", "1" }),
]);
