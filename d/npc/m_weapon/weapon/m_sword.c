...
//      set_name(w_name, ({w_id}));
        ...
        switch(w_or)
                ...
                case "千年神木" :
                        ...
                        set("wield_msg", "$N往怀中一摸，掏出了一柄"+HIR""+w_name+""+NOR"。\n");
                ...
                case "海底金母" :
                        ...
                        set("wield_msg", "$N往怀中一摸，掏出了一柄"+MAG""+w_name+""+NOR"。\n");
                ...
                case "寒丝羽竹" :
                        ...
                        set("wield_msg", "$N往怀中一摸，掏出了一柄"+HIG""+w_name+""+NOR"。\n");
...
int do_duanlian(object weapon)
{
       ...
       if( (int)me->query("weapon/lv") > 21)
        ...
        if( (int)me->query("maximum_force") < 2200 )
                return notify_fail("你的内力上限不够，无法锻炼剑气！\n");
