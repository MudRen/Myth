...
int perform(object me, object target)
{
        ...
        message_combatd(HIC"$N招式一缓，手中"+weapon->name()+HIC"仿佛挽了千斤似的，使出了惊雷鞭法的绝学--『雷殛怒火』！\n\n" NOR,me,target,"");        
        message_combatd(CYN"$N气运丹田，平平砸出一锏，慢，却嘶嘶作风雷之声。\n"NOR,me,target,"");
        ...
        message_combatd(CYN"$N由静转动，一动便急如风，脚踏奇门，锏走奇招，锏锏从$n意想不到的方位无声无息地砸出！\n" NOR,me,target,"");
...
//              damage=random(100)+me->query("force_factor");
        ...
        message_combatd(CYN"$N突然收住身形，回步而立，撤锏于背后，无招胜有招，无形胜有形。\n"NOR,me,target,"");
        message_combatd(CYN"这一招『雷殛怒火』把惊雷鞭法的精髓要旨发挥地酣畅爽快！\n\n"NOR,me,target,"");
