...
int perform(object me, object target)
{
        ...
        ||      !me->is_fighting(target) )
                return notify_fail("［阴阳决］只能对战斗中的对手使用。\n");
/*
...
*/  
        ...
        {       
                message_vision(HIB "\n\n$N使出一式两仪剑法中的［阴阳诀］，手中"+(me->query_temp("weapon"))->name()+"将$n的兵刃越缠越紧，$n一个把持不住，手中"+ 
weapon->name()+  "脱手而飞！\n\n" NOR, me,target);
                weapon->unequip();
                if( weapon->unequip()) 
        ...
        {
                message_vision(HIB "\n\n$N使出一式两仪剑法中的［阴阳诀］，手中"+(me->query_temp("weapon"))->name()+  "将$n越缠越紧，逼的$n一阵手忙脚乱！\n\n" NOR, me,target);
