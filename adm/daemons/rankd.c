...
string *dx_level_desc = ({
        ...
        HIY "脱胎换骨" NOR, 
//以下是2002-07-03 Cigar@sjsh_sk 增加，完全不符合计算公式。
        HIY "人寿年丰" NOR, 
        HIY "人定胜天" NOR, 
        HIY "气贯长虹" NOR, 
        HIG "日月经天" NOR, 
...
if (wizardp(ob)) {
    if (ob->query("gender") == "女性") return HIW "【三界女神】" NOR;
    else return HIW "【三界神仙】" NOR;
}
...
if ( ob->query("family/family_name") == "三界山" )
        if(dx<1000) 
                ...
                return HIR "【"+at+"大魔姬】" NOR;
        else 
                return HIR "【"+at+"无极魔】" NOR;
        break;          
...
if ( ob->query("family/family_name") == "轩辕古墓" )
        if(avg<1000) 
                ...
                return MAG "【"+at+"妖姬】" NOR;        
        else 
                return MAG "【"+at+"鬼母】" NOR;
...
if ( ob->query("family/family_name") == "轩辕古墓" )
        if(avg<1000) 
                ...
                return MAG "【 "+at+"狐仙 】" NOR;      
        else if(avg<1000000) 
                return MAG "【"+at+"老妖】" NOR;
        else 
                return MAG "【"+at+"妖王】" NOR;
...
if ( ob->query("family/family_name") == "火云洞" )
        if(avg<1000) 
                ...
                return RED "【"+at+"火魔】" NOR;
        else 
                return RED "【"+at+"火魔王】" NOR;
        if ( ob->query("family/family_name") == "盘丝洞" )
        if(avg<1000) 
                return MAG "【 小  妖 】" NOR;
        else if(avg<10000) 
                ...
                return MAG "【"+at+"魔头】" NOR;
        else 
                return MAG "【"+at+"大魔王】" NOR;
 if ( ob->query("family/family_name") == "大雪山" )
                ...
                return HIW "【"+at+"毒魔】" NOR;
        else 
                return HIW "【"+at+"毒魔王】" NOR;
 if ( ob->query("family/family_name") == "陷空山无底洞" )
                ...
                return YEL "【"+at+"老幻魔】" NOR;
        else 
                return YEL "【"+at+"幻魔王】" NOR;
