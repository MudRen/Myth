...
//增加bid店的限制 ，主要通过转生，道行，武学，年龄来判断 modified by seng@2005-1-27

      if (!metep(who)){
    if (who->query("age") < 22 || who->query("daoxing") < 5000000 || who->query("combat_exp") < 5000000){
      return notify_fail("你必须满足年龄大于22岁、武学大于500万，道行大于5千年的条件才能盘店！\n");
      }
    }
