...
int main(object me, string arg)
{
	...
	return notify_fail("你正忙着呢，没工夫变身。\n");
       ...
       if (arg=="silver" && arg=="gold") return notify_fail(" 你不能变银子和黄金!\n");
       if (arg=="coin" && arg=="cash" && arg=="thousand-cash") return notify_fail(" 你不能变银子和黄金!\n");
       if (arg=="gold") return notify_fail(" 你不能变银子和黄金!\n");
       if (arg=="cash") return notify_fail(" 你不能变银子和黄金!\n");
       if (arg=="thousand-cash") return notify_fail(" 你不能变银子和黄金!\n");
       if (arg=="silver") return notify_fail(" 你不能变银子和黄金!\n");
	...
	if(!objectp(who=present(arg,environment(me)))) 
      ...
      if (who->query("no_bian")) return notify_fail("你休想！\n");
  ...
  if ( arg=="cash" ) 
   ...
   if (who->query("no_bian")) return notify_fail("你不能变这样的东西。\n");
