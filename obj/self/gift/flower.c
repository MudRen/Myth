...
void create ()
{
	set_name(HIM "樱花香囊" NOR, ({ "prunus serrulata", "prunus", "serrulata" }));
	set_weight(100);
	set("long",
...
重瓣，粉红色，有香气。\n"NOR);
	...
	set("no_sell", "这么漂亮的樱花香囊你也要换钱吗？\n");
	set("no_drop", "仍掉了樱花香囊，就象仍掉了一个梦想，还是好好珍惜它吧。\n");
	set("no_give", "樱花香囊需要珍惜，不能轻易送人。\n");
	set("no_put", "樱花香囊需要展示出来，不能私藏的。\n");
